        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(User::Timezone).string_len(50).not_null().default("Asia/Shanghai"))
                    .col(ColumnDef::new(User::Language).string_len(10).not_null().default("zh-CN"))
                    .col(ColumnDef::new(User::IsSiteAdmin).boolean().not_null().default(false))
