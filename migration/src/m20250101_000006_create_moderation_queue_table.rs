        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(ModerationQueue::Id).uuid().not_null().primary_key())
                    .col(ColumnDef::new(ModerationQueue::ListId).uuid().not_null())
                    .col(ColumnDef::new(ModerationQueue::MessageId).uuid())
                    .col(ColumnDef::new(ModerationQueue::FromAddr).string_len(255).not_null())
                    .col(ColumnDef::new(ModerationQueue::Subject).string_len(512))
                    .col(ColumnDef::new(ModerationQueue::Reason).string_len(50).not_null())
                    .col(ColumnDef::new(ModerationQueue::Status).string_len(20).not_null().default("pending"))
                    .col(ColumnDef::new(ModerationQueue::Source).string_len(20).not_null().default("manual"))
                    ...
                    .col(ColumnDef::new(ModerationQueue::AiReviewed).boolean().not_null().default(false))
                    ...
                    .col(ColumnDef::new(ModerationQueue::CreatedAt).timestamp_with_time_zone().not_null())
                    .foreign_key(
                        ForeignKey::create()
