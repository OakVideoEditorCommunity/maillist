        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(Subscriber::Id).uuid().not_null().primary_key())
                    ...
                    .col(ColumnDef::new(Subscriber::Status).string_len(20).not_null().default("pending"))
                    .col(ColumnDef::new(Subscriber::DigestMode).string_len(20).not_null().default("none"))
                    .col(ColumnDef::new(Subscriber::SubscribeIp).string_len(45))
                    .col(ColumnDef::new(Subscriber::SubscribeSource).string_len(50))
                    .col(ColumnDef::new(Subscriber::BounceCount).integer().not_null().default(0))
                    .col(ColumnDef::new(Subscriber::LastBounceAt).timestamp_with_time_zone())
                    .col(ColumnDef::new(Subscriber::Token).string_len(64).not_null().unique_key())
                    .col(ColumnDef::new(Subscriber::ConfirmedAt).timestamp_with_time_zone())
                    .col(ColumnDef::new(Subscriber::CreatedAt).timestamp_with_time_zone().not_null())
                    .col(ColumnDef::new(Subscriber::UpdatedAt).timestamp_with_time_zone().not_null())
                    .foreign_key(
                        ForeignKey::create()
