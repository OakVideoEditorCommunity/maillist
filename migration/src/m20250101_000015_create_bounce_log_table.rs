        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(BounceLog::Id).uuid().not_null().primary_key())
                    .col(ColumnDef::new(BounceLog::SubscriberId).uuid())
                    .col(ColumnDef::new(BounceLog::MessageId).uuid())
                    .col(ColumnDef::new(BounceLog::BounceType).string_len(20).not_null())
                    ...
                    .col(ColumnDef::new(BounceLog::CreatedAt).timestamp_with_time_zone().not_null())
                    .foreign_key(
                        ForeignKey::create()
